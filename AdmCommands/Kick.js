...
module.exports = (bot) => {
    ...
    MsgEmbedNoUser.setTitle(`Kick Command Error Warning`)
    ...
    MsgEmbedNoUser.setFooter(`Frogbot System Administrator ~ Up Command "Kick"`, "https://cdn2.vectorstock.com/i/1000x1000/18/71/hazard-warning-warn-symbol-icon-flat-sign-symbol-vector-34241871.jpg")
    ...
    MsgEmbedNoMemberUser.setTitle(`Kick Command Error Warning`)
    ...
    MsgEmbedNoMemberUser.setFooter(`Frogbot System Administrator ~ Up Command "Kick"`, "https://cdn2.vectorstock.com/i/1000x1000/18/71/hazard-warning-warn-symbol-icon-flat-sign-symbol-vector-34241871.jpg")
    ...
    MsgEmbedRemovedMember.setTitle(`Kick Command Information`)
    ...
    MsgEmbedRemovedMember.setDescription(`${msg.author.username}, sucesso obtido ao executar o comando KICK!`)
    MsgEmbedRemovedMember.setFooter(`Frogbot System Administrator ~ Up Command "Kick"`, "https://www.bianchini.com.br/images/sucess.png")
    ...
    MsgEmbedErrorPermission.setTitle(`Kick Command Error Warning`)
    ...
    MsgEmbedErrorPermission.setFooter(`Frogbot System Administrator ~ Up Command "Kick"`, "https://cdn2.vectorstock.com/i/1000x1000/18/71/hazard-warning-warn-symbol-icon-flat-sign-symbol-vector-34241871.jpg")
// Fim do espaço destinado ao fim de criação de Embeds
        ...
        if (msg.content.startsWith('Frogbot expulse')) {
